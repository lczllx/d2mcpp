...
// license: Apache-2.0
// reference solution for: src/cpp14/tests/01-relaxed-constexpr/0.cpp
//
// 用途: 仅给 CI 与维护者参考使用，不是教程入口。
// 教程练习入口: src/cpp14/tests/01-relaxed-constexpr/0.cpp
//
...
int main() {
    ...
    d2x::check_eq(f10, 3628800, "factorial(10) == 3628800");
